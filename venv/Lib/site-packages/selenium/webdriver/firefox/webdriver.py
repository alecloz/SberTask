...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(self, firefox_profile=None, firefox_binary=None,
        ...
        :param service_log_path: Where to log information from the src.
        :param firefox_options: Deprecated argument for options
        :param service_args: List of args to pass to the src service
    ...
    def quit(self):
        """Quits the src and close every associated window."""
        try:
    ...
    def install_addon(self, path, temporary=None):
        ...
        :Usage:
            src.install_addon('/path/to/firebug.xpi')
        """
        payload = {"path": path}
    ...
    def uninstall_addon(self, identifier):
        ...
        :Usage:
            src.uninstall_addon('addon@foo.com')
        """
